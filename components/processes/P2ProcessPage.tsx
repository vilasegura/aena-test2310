...
const P2ProcessPage: React.FC<{ onBack: () => void }> = ({ onBack }) => {
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-800">P2. Envío de datos a sistemas corporativos</h2>
